...
.get("/search/:id/:query", search)

// sort user's recipes by tags
.get("/search/:id/:tag", recipeTags)

// generate random recipe
.get("/random/:id", randomRecipe)

// find recipes under 30 mins total recipe
// I could find a way to seperate the time from the unit of time
// The scaper imports the recipe's total time as string
// .get("/totalTime/:id", totalTime)
